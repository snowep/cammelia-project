				...
				r(t, [
					{
						...
						value: function (t) {
							...
							if (f.config.dataLabels.enabled) {
								...
								P = p.getTextRects(
									f.globals.yLabelFormatters[0](M),
					...
					},
					{
						...
						value: function (t) {
							...
							if (c.enabled && !b) {
								...
								var v = "";
								void 0 !== s &&
									(v = p(s, { seriesIndex: r, dataPointIndex: o, w: d }));
						...
						value: function (t, i) {
							...
							for (
								...
								for (
									...
									if (
										((g = v.yDivision), (p = v.barHeight), this.isHorizontal)
									) {
										P = d + p * this.visibleI;
						...
						value: function (t) {
							...
							return (
								...
								u > -1 &&
									...
									(h = l.globals.seriesRangeBar[e][u].overlaps).indexOf(c) >
										-1 &&
									(a =
			...
			function t(e) {
				...
				(this.axesUtils = new G(e)),
					...
					this.xaxisBorderWidth.indexOf("%") > -1
						? (this.xaxisBorderWidth =
								(i.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10)) /
								100)
							...
							for (
								...
								(C.background = s[l]),
									...
									(C.width = Array.isArray(w)
										...
										: parseFloat(w) + "px"),
									(C.left =
										(Array.isArray(p) ? parseFloat(p[l]) : parseFloat(p)) +
										"px"),
									(C.top =
				...
				r(t, [
					...
					},
					{
						...
						value: function (t) {
							...
							e.globals.isBarHorizontal &&
								(s =
									new E(this.ctx).getActiveConfigSeriesIndex(!1, "desc") + 1);
							var r = e.globals.dom.baseEl.querySelector(
						...
						value: function (t) {
							for (
								var e = t.series,
									...
									A = l.pathFromLine,
									S = l.pathFromArea,
									C = x.isNumber(p.globals.minYArr[i])
										? p.globals.minYArr[i]
										: p.globals.minY,
									L =
										p.globals.dataPoints > 1
											? p.globals.dataPoints - 1
								...
								if (p.globals.isXNumeric) {
									...
									void 0 === p.globals.seriesX[i][P + 1] &&
										(T = p.globals.seriesX[i][L - 1]),
											...
											this.prevSeriesY[
												(function (t) {
													for (
														...
														if (
															p.globals.collapsedSeriesIndices.indexOf(t) > -1
														) {
															e--;
															break;
														}
						...
						value: function (t) {
							...
							if (
								...
								f.globals.hasNullValues
									...
									(l = o),
									s === e[i].length - 2 &&
										((c = c + p.curve(n, l, r, o, r, b) + p.move(r, o) + "z"),
