		...
		a =
			...
			)),
			{
				...
				ManageThemeBackground: function () {
					var a, e;
					null != (a = i.LogoBg) && "" != a
						? $("#" + t + " .topbar .top-navbar .navbar-header").attr(
								"data-logobg",
								a
						  )
						: $("#" + t + " .topbar .top-navbar .navbar-header").attr(
						...
						null != (e = i.NavbarBg) && "" != e
							? ($("#" + t + " .topbar .navbar-collapse").attr(
									"data-navbarbg",
									e
							  ),
							  $("#" + t + " .topbar").attr("data-navbarbg", e),
							  $("#" + t).attr("data-navbarbg", e))
							: ($("#" + t + " .topbar .navbar-collapse").attr(
									"data-navbarbg",
									"skin1"
							  ),
							  $("#" + t + " .topbar").attr("data-navbarbg", "skin1"),
							  $("#" + t).attr("data-navbarbg", "skin1"));
				},
				ManageSidebarType: function () {
					switch (i.SidebarType) {
						case "full":
							$("#" + t).attr("data-sidebartype", "full");
							var a = function () {
								(0 < window.innerWidth
									? window.innerWidth
							...
							break;
						case "stylish":
							$("#" + t).attr("data-sidebartype", "stylish");
							a = function () {
								(0 < window.innerWidth
									? window.innerWidth
									: this.screen.width) < 1170
							...
							break;
						case "mini-sidebar":
							$("#" + t).attr("data-sidebartype", "mini-sidebar"),
								$(".sidebartoggler").on("click", function () {
									$("#main-wrapper").toggleClass("mini-sidebar"),
										$("#main-wrapper").hasClass("mini-sidebar")
											? ($(".sidebartoggler").prop("checked", !0),
							...
							break;
						case "iconbar":
							$("#" + t).attr("data-sidebartype", "iconbar");
							a = function () {
								(0 < window.innerWidth
									? window.innerWidth
									: this.screen.width) < 1170
							...
							break;
						case "overlay":
							$("#" + t).attr("data-sidebartype", "overlay");
							a = function () {
								(0 < window.innerWidth
									? window.innerWidth
				...
				ManageSidebarColor: function () {
					var a;
					null != (a = i.SidebarColor) && "" != a
						? $("#" + t + " .left-sidebar").attr("data-sidebarbg", a)
						: $("#" + t + " .left-sidebar").attr("data-sidebarbg", "skin1");
				},
				ManageSidebarPosition: function () {
					var a = i.SidebarPosition,
						e = i.HeaderPosition;
					switch (i.Layout) {
						case "vertical":
						case "horizontal":
							1 == a
								? ($("#" + t).attr("data-sidebar-position", "fixed"),
								  $("#sidebar-position").prop("checked", !0))
								: ($("#" + t).attr("data-sidebar-position", "absolute"),
								  $("#sidebar-position").prop("checked", !1)),
								1 == e
									? ($("#" + t).attr("data-header-position", "fixed"),
									  $("#header-position").prop("checked", !0))
									: ($("#" + t).attr("data-header-position", "relative"),
				...
				ManageBoxedLayout: function () {
					...
					switch (i.Layout) {
						...
						case "horizontal":
							1 == a
								? ($("#" + t).attr("data-boxed-layout", "boxed"),
								  $("#boxed-layout").prop("checked", !0))
								: ($("#" + t).attr("data-boxed-layout", "full"),
	...
	$(function () {
		...
		$("#chat .message-center a").on("click", function () {
			var a = $(this).find(".mail-contnet h5").text(),
				...
				t = $(this).find(".profile-status").attr("data-status");
			if ($(this).hasClass("active"))
				$(this).toggleClass("active"), $(".chat-windows #user-chat" + i).hide();
			else if (
				($(this).toggleClass("active"),
				$(".chat-windows #user-chat" + i).length)
			)
				$(".chat-windows #user-chat" + i)
