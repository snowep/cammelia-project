...
$(function () {
	$(".modalUbah").on("click", function () {
		...
		$.ajax({
			url: "http://project-simpeda.online/public/school/getEdit",
			data: { npsn: npsn },
			method: "POST",
			dataType: "json",
			success: function (data) {
	...
	$(".modalUbahUser").on("click", function () {
		...
		$.ajax({
			url: "http://project-simpeda.online/public/user/getEdit",
			data: { id: id },
			method: "POST",
			dataType: "json",
			success: function (data) {
	...
	$(".modalUbahReport").on("click", function () {
		...
		$.ajax({
			url: "http://project-simpeda.online/public/report/getEdit",
			data: { id: id },
			method: "POST",
			dataType: "json",
			success: function (data) {
	...
	$.ajax({
		url: "http://project-simpeda.online/public/user/getUserByUsername",
		dataType: "json",
		success: function (data) {
			//if data.level == admin
			if (data.level == "admin" || data.level == "superuser") {
