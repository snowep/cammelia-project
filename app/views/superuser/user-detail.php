<div class="page-titles">
    <div class="row">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 d-flex align-items-center">
                    <li class="breadcrumb-item">
                        <a href="<?= BASEURL ?>/<?= $_SESSION['role'] ?>/user_list">User</a>
                    </li>
        ...
        <div class="col-lg-4 col-md-6 d-none d-md-flex align-items-center justify-content-end">
            ...
            <a href="<?= BASEURL ?>/<?= $_SESSION['role'] ?>/user_delete/<?= $data['users']['id'] ?>" class="btn btn-outline-danger d-flex align-items-center ms-2" onclick="return confirm('Yakin?')">
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <a href="<?= BASEURL ?>/<?= $_SESSION['role'] ?>/user_list" class="btn btn-light-secondary btn-rounded">
